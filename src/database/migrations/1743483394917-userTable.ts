...
export class UserTable1743483394917 implements MigrationInterface {
    name = 'UserTable1743483394917'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."assets_condition_enum" AS ENUM('New', 'Good', 'Damaged', 'Needs Repair')`);
        await queryRunner.query(`CREATE TYPE "public"."assets_assigned_status_enum" AS ENUM('Assigned', 'Available')`);
        ...
        await queryRunner.query(`ALTER TABLE "assets" ADD CONSTRAINT "FK_6ce7e037e1bac19ddf02d1d82d6" FOREIGN KEY ("assigned_to") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."assets_assigned_status_enum"`);
