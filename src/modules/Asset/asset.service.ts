...
export class AssetService {
    ...
    async exchangeAsset(id: string, exchangeId: string, assigned_to: string, choice: boolean){
        try{
            if(choice){
                await this.assetRepository.update(id,{ assigned_to: null as any, assigned_status: AssignedStatus.AVAILABLE, assigned_date: null as any, return_date: new Date()});
